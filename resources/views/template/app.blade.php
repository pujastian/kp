        ...
        <div id="nav">
            ...
            <div id="nav-fixed">
                <div class="container">
                    <!-- logo -->
                    <div class="nav-logo" >
                        <a href="#" class="logo"><img src="{{asset('front/img/logostmik.png')}}" alt=""> </a>
                    </div>
                    <!-- /logo -->

                    <!-- nav -->
                    <ul class="nav-menu nav navbar-nav">
                        <li class="cat-1"><a href="#">Profil</a></li>
                        <li class="cat-2"><a href="#">Referensi</a></li>
                    ...
                    <div class="nav-btns">
                        ...
                        <a href=""><i style="color: white;" ><i class="fa fa-sign-in" style="color: white;"></i> Sign In</a>
