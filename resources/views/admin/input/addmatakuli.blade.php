...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
			  <form action="/admin/tambahmatakuli" method="post">
			  {{ csrf_field() }}
                <div class="card-body">
                  <div class="form-group">
                    <label for="idmatakuliah">Id Matakuliah</label>
                    <input type="text" class="form-control" name="id_matakuliah" required="required">
                  </div>
                  <div class="form-group">
                    <label for="kodematakuliah">Kode Matakuliah</label>
                    <input type="text" class="form-control" name="kode_matakuliah" required="required">
                  </div>
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="teori" required="required">
          </div>
          <div class="form-group">
                    <label for="praktek">Praktek</label>
                    <input type="text" class="form-control" name="praktek" required="required">
          </div>
          ...
          <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="prasyarat" required="required">
          </div>
          <div class="form-group">
